<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMaster2.master" AutoEventWireup="true" CodeFile="UKategoriler.aspx.cs" Inherits="UKategoriler" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <div class="col-md-4 bosluk2 col-lg-4 col-sm-4">
                                    ...
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-link float-right" NavigateUrl='<%# Eval("kitapturu","~/UKitaplar.aspx?kat={0}") %>'>+Detay</asp:HyperLink>
                                </div>
                            </ItemTemplate>
                    </asp:Repeater>
                </div>
